...
<link href="/app/view/layout/styles/layout.css" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
...
<div class="bgded" style="background-image:url('/app/view/images/demo/backgrounds/background.jpg');"> 
  <!-- ################################################################################################ -->
  <div class="wrapper overlay">
    <header id="header" class="hoc clear">
      <nav id="mainav" class="clear"> 
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Pages</a>
            <ul>
              <li><a href="/app/view/pages/gallery.html">Gallery</a></li>
              <li><a href="/app/view/pages/full-width.html">Full Width</a></li>
              <li><a href="/app/view/pages/sidebar-left.html">Sidebar Left</a></li>
              <li><a href="/app/view/pages/sidebar-right.html">Sidebar Right</a></li>
              <li><a href="/app/view/pages/basic-grid.html">Basic Grid</a></li>
            </ul>
          </li>
      ...
      <div id="logo"> 
        <!-- ################################################################################################ -->
        <h1><a href="index.html">Arialogic</a></h1>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group blocks">
      <li class="one_quarter first bgded overlay" style="background-image:url('/app/view/images/demo/320x320.png');"><a class="btn medium" href="#">Fermentum</a><br>
        Ultrices</li>
      <li class="one_quarter bgded overlay" style="background-image:url('/app/view/images/demo/320x320.png');"><a class="btn medium" href="#">Hendrerit</a><br>
        Posuere</li>
      <li class="one_quarter bgded overlay" style="background-image:url('/app/view/images/demo/320x320.png');"><a class="btn medium" href="#">Gravida</a><br>
        Cubilia</li>
      <li class="one_quarter bgded overlay" style="background-image:url('/app/view/images/demo/320x320.png');"><a class="btn medium" href="#">Porttitor</a><br>
        Convallis</li>
    </ul>
    <!-- ################################################################################################ -->
    <!-- / main body -->
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('/app/view/images/demo/backgrounds/01.png');">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_half first">
        <div class="clear"><img src="/app/view/images/demo/80x80.png" alt=""> <span class="block"><strong>A.Doe</strong> / <em>Position, Company Name</em></span>
          <blockquote>Ornare sed nec sagittis nisi nulla nec aliquam mi interdum et malesuada fames&hellip;</blockquote>
        </div>
      </li>
      <li class="one_half">
        <div class="clear"><img src="/app/view/images/demo/80x80.png" alt=""> <span class="block"><strong>B.Doe</strong> / <em>Position, Company Name</em></span>
  ...
  <section class="hoc container clear"> 
    ...
    <ul class="nospace elements">
      <li class="one_third first">
        <article><a href="#"><img src="/app/view/images/demo/320x220.png" alt=""></a>
          <div class="txtwrap">
...
<div class="wrapper coloured">
  <div class="hoc clear"> 
    ...
    <figure id="logos">
      <ul class="nospace group">
        <li><a href="#"><img src="/app/view/images/demo/logo.png" alt=""></a></li>
        <li><a href="#"><img src="/app/view/images/demo/logo.png" alt=""></a></li>
        <li><a href="#"><img src="/app/view/images/demo/logo.png" alt=""></a></li>
        <li><a href="#"><img src="/app/view/images/demo/logo.png" alt=""></a></li>
        <li><a href="#"><img src="/app/view/images/demo/logo.png" alt=""></a></li>
...
<!-- JAVASCRIPTS -->
<script src="/app/view/layout/scripts/jquery.min.js"></script>
<script src="/app/view/layout/scripts/jquery.backtotop.js"></script>
<script src="/app/view/layout/scripts/jquery.mobilemenu.js"></script>
<!-- IE9 Placeholder Support -->
<script src="/app/view/layout/scripts/jquery.placeholder.min.js"></script>
<!-- / IE9 Placeholder Support -->
</body>
</html>